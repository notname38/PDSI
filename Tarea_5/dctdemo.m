...
%
%   The following images are courtesy of J. C. Russ, The Image Processing
%   Handbook, Third Edition, 1998, CRC Press: Saturn and Flower.
%                                                      
...
case 'Flower',
   flower = [];  % Make sure flower is parsed as a variable
   load imdemos flower
